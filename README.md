...
### ✨ Key Enhancements
- ** Native Apple Silicon (arm64)**: Optimized for M1/M2/M3/M4 Macs. No Rosetta required.
- **🧊 Liquid Glass UI**: A full-spectrum glassmorphic overhaul utilizing native macOS vibrancy and hardware-accelerated translucency.
- **✨ Cyber Aurora Shimmer**: A dynamic, animated background that breathes with vibrant cyan, purple, and magenta gradients.
- **🔷 Hexagonal Branding**: A custom-crafted hexagonal logo that replaces the original heart, specifically designed for this Liquid Glass edition.
- **📊 Gradient Progress Bars**: Re-imagined download telemetry with sophisticated color-shifting gradients.
